...
/*
 */
bool String::isdigit(int code) {
	return (code >= '0' && code <= '9');
}

bool String::islower(int code) {
	return (code >= 'a' && code <= 'z');
}

bool String::isupper(int code) {
	return (code >= 'A' && code <= 'Z');
}

bool String::isalpha(int code) {
...
/*
 */
String String::memory(size_t size) {
	String ret;
...
String String::format(const char *format,va_list argptr) {
	String ret;
...
/*
 */
String String::trim(const char *str,const char *symbols) {
...
String String::replace(const char *str,const char *before,const char *after) {
	String ret;
	const char *s = str;
...
String String::substr(const char *str,int pos,int len) {
	String ret;
...
String String::addslashes(const char *str) {
	String ret;
	const char *s = str;
	while(*s) {
		if(*s == '\t') ret += "\\t";
...
String String::stripslashes(const char *str) {
	String ret;
	const char *s = str;
	while(*s) {
		if(*s == '\\') {
